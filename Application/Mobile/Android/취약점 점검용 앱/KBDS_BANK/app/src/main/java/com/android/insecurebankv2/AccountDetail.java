...
public class AccountDetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button = (Button)findViewById(R.id.account_update);
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                extras.putString("account_number", account_number);
                extras.putString("balance", balance);

                Intent uA = new Intent(getApplicationContext(), UpdateAccount.class);
                uA.putExtra("extras", extras);
                startActivity(uA);
        ...
        delete_button = (Button)findViewById(R.id.account_delete);
        delete_button.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new AccountDetail.RequestDeleteAccountTask().execute(uname);
    ...
    class RequestDeleteAccountTask extends AsyncTask< String, String, String > {
        ...
        */
        public void postData(String valueIWantToSend) throws ClientProtocolException, IOException, JSONException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
            ...
            HttpPost httppost = new HttpPost(protocol + serverip + ":" + serverport + "/deleteaccount");
